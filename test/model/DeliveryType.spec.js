...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.DeliveryType();
  });
  ...
  describe('DeliveryType', function() {
    it('should create an instance of DeliveryType', function() {
      // uncomment below and update the code to test DeliveryType
      //var instane = new SwappyRestApi.DeliveryType();
      //expect(instance).to.be.a(SwappyRestApi.DeliveryType);
    });
