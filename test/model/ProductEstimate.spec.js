...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.ProductEstimate();
  });
  ...
  describe('ProductEstimate', function() {
    it('should create an instance of ProductEstimate', function() {
      // uncomment below and update the code to test ProductEstimate
      //var instane = new SwappyRestApi.ProductEstimate();
      //expect(instance).to.be.a(SwappyRestApi.ProductEstimate);
    });
