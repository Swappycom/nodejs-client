...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.ShortProductOffer();
  });
  ...
  describe('ShortProductOffer', function() {
    it('should create an instance of ShortProductOffer', function() {
      // uncomment below and update the code to test ShortProductOffer
      //var instane = new SwappyRestApi.ShortProductOffer();
      //expect(instance).to.be.a(SwappyRestApi.ShortProductOffer);
    });
