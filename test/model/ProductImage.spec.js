...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.ProductImage();
  });
  ...
  describe('ProductImage', function() {
    it('should create an instance of ProductImage', function() {
      // uncomment below and update the code to test ProductImage
      //var instane = new SwappyRestApi.ProductImage();
      //expect(instance).to.be.a(SwappyRestApi.ProductImage);
    });
