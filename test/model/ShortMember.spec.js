...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.ShortMember();
  });
  ...
  describe('ShortMember', function() {
    it('should create an instance of ShortMember', function() {
      // uncomment below and update the code to test ShortMember
      //var instane = new SwappyRestApi.ShortMember();
      //expect(instance).to.be.a(SwappyRestApi.ShortMember);
    });
