...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.ShortAddress();
  });
  ...
  describe('ShortAddress', function() {
    it('should create an instance of ShortAddress', function() {
      // uncomment below and update the code to test ShortAddress
      //var instane = new SwappyRestApi.ShortAddress();
      //expect(instance).to.be.a(SwappyRestApi.ShortAddress);
    });
    ...
    it('should have the property administrativeArea (base name: "administrative_area")', function() {
