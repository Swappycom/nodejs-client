...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.TempImage();
  });
  ...
  describe('TempImage', function() {
    it('should create an instance of TempImage', function() {
      // uncomment below and update the code to test TempImage
      //var instane = new SwappyRestApi.TempImage();
      //expect(instance).to.be.a(SwappyRestApi.TempImage);
    });
