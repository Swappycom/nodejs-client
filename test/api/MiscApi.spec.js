...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.MiscApi();
  });
  ...
  describe('MiscApi', function() {
    describe('getSoftwareVersion', function() {
      it('should call getSoftwareVersion successfully', function(done) {
        //uncomment below and update the code to test getSoftwareVersion
        //instance.getSoftwareVersion(pet, function(error) {
