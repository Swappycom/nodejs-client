...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwappyRestApi.DataApi();
  });
  ...
  describe('DataApi', function() {
    ...
    describe('getCategory', function() {
      it('should call getCategory successfully', function(done) {
        ...
        //instance.getCategory(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDurations', function() {
      it('should call getDurations successfully', function(done) {
        //uncomment below and update the code to test getDurations
        //instance.getDurations(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOptions', function() {
      it('should call getOptions successfully', function(done) {
        ...
        //instance.getOptions(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShippingMethods', function() {
      it('should call getShippingMethods successfully', function(done) {
        //uncomment below and update the code to test getShippingMethods
        //instance.getShippingMethods(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
